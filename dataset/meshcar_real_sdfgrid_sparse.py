...
class SparseSDFGridDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sdf_grid_064 = torch.from_numpy(np.load(self.mesh_directory / selected_item / "064.npy")) - self.vox_sizes[0] / 3
        sdf_grid_128 = torch.from_numpy(np.load(self.mesh_directory / selected_item / "128.npy")) - self.vox_sizes[1] / 3
        real_sample, masks, view_matrices, projection_matrices, mvp = self.get_image_and_view()
        ...
        return {
            ...
            "y_val": torch.zeros_like(sparse_sdf.float()).expand(-1, 3),
