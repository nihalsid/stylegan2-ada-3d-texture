...
class Generator(torch.nn.Module):
    ...
    def __init__(self, z_dim, w_dim, w_num_layers, num_faces, color_channels, semantic_channels, c_dim=0, channel_base=16384):
        super().__init__()
        self.z_dim = z_dim
        self.w_dim = w_dim
        self.c_dim = c_dim
        ...
        self.synthesis = SynthesisNetwork(w_dim=w_dim, num_faces=num_faces, color_channels=color_channels, semantic_channels=semantic_channels, channel_base=channel_base)
