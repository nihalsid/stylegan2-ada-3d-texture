...
CARLA = {
    0: {'batch_size': 8, 'num_steps': 48, 'img_size': 32, 'batch_split': 1, 'gen_lr': 4e-5, 'disc_lr': 4e-4},
    int(10e3): {'batch_size': 6, 'num_steps': 48, 'img_size': 64, 'batch_split': 1, 'gen_lr': 2e-5, 'disc_lr': 2e-4},
    int(55e3): {'batch_size': 4, 'num_steps': 48, 'img_size': 128, 'batch_split': 1, 'gen_lr': 10e-6, 'disc_lr': 10e-5},
    int(200e3): {},
    'enc_lr': 0.0001,
