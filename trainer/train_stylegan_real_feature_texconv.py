...
class StyleGAN2Trainer(pl.LightningModule):
    ...
    def __init__(self, config):
        ...
        self.G = Generator(config.latent_dim, config.latent_dim, config.num_mapping_layers, config.num_faces, 3, aggregation_function=config.conv_aggregation, channel_base=config.g_channel_base, channel_max=config.g_channel_max)
        ...
        self.E = GraphEncoder(self.train_set.num_feats, conv_layer=FaceConv if config.enc_conv == 'face' else TextureConv)
        self.R = None
